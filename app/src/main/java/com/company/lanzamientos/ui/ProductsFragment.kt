...
import com.company.lanzamientos.data.KpiProduct
...
class ProductsFragment : Fragment() {
    ...
    data.forEach {
        ...
        card.findViewById<TextView>(R.id.tvTitle).text = it.name
